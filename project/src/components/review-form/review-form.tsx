...
export default function ReviewForm() {
  ...
  return (
    <form onSubmit={handleFormSubmit} className="reviews__form form" action="#" method="post">
      ...
      <textarea onChange={textareaChangeHandle} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" disabled ={postReviewstStatus.isLoading}></textarea>
      <div className="reviews__button-wrapper">
        ...
        <button className="reviews__submit form__submit button" type="submit" disabled ={isFormDisabled}> {postReviewstStatus.isLoading ? <LoginLoader /> : 'Submit'}</button>
      </div>
    </form>
  );
}
